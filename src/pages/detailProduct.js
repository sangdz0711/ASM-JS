		...
		return /*html*/ `
			...
			<main class=" my-2 relative">
				<div class="main-right col-span-6">
                    <div class="tittle-sp bg-blue-500 text-white text-xl py-3 px-5 mb-[20px]"><span class="">CHI TIẾT SẢN PHẨM</span> </div>
            ...
            <div class="spcl col-span-8">
                <div class="bg-blue-500 text-white text-xl py-3 px-5 mt-[10px]"><span class="">Sản Phẩm Cùng Loại</span> </div>
