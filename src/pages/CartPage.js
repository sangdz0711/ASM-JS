...
const CartPage = {
	print() {
		...
		return /*html*/ ` 
			...
			<form action="" id="form-cart">
				<h2 class="font-bold text-2xl text-center text-red-400">GIỎ HÀNG</h2>
	...
	<div class="thanh-toan text-center my-4">
		<button type="submit"
			class="text-white bg-red-500 inline-block rounded font-bold text-2xl px-4 py-3"><a href="/#/thanhtoan">Thanh
				Toán</a></button>
	</div>
			</form >
		</div >
